...
public class VoltageCl0 {
    ...
    static {
        registerVoltagePath(CL0_VOLTAGE);
    }
    ...
    public static boolean supported() {
        ...
        PATH = null;
        sFreqs = null;
        String path = VoltageTables.findCpuVoltageTable(CL0_VOLTAGE, "cluster0", "cl0");
    ...
    public static boolean isSingleCluster() {
        return VoltageTables.isSingleClusterCpuVoltageTable(getPath());
    }
